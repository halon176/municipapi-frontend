...
function ElencoComuni() {
  ...
  useEffect(() => {
    async function fetchItems() {
      ...
      const response = await axios.get(`${host_protocol}://${host_url}:${host_port}/comuni`, config);
...
function ElencoProvince() {
  ...
  useEffect(() => {
    async function fetchItems() {
      ...
      const response = await axios.get(`${host_protocol}://${host_url}:${host_port}/province`, config);
      setItems(response.data);
    }
    fetchItems();
  }, []);
...
function ElencoRegioni() {
  ...
  useEffect(() => {
    async function fetchItems() {
      ...
      const response = await axios.get(`${host_protocol}://${host_url}:${host_port}/regioni`, config);
      setItems(response.data);
    }
    fetchItems();
  }, []);
